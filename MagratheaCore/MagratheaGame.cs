...
namespace MagratheaCore
{
    public class MagratheaGame : Game
    {
        ...
        private CenteredCamera _camera;
        ...
        protected override void Initialize()
        {
            ...
            Matrix cameraProjectionMatrix = Matrix.CreatePerspectiveFieldOfView(MathHelper.ToRadians(60), GraphicsDevice.Viewport.AspectRatio, CenteredCamera.NearPlaneDistance, CenteredCamera.FarPlaneDistance);
            _camera = new CenteredCamera()
            {
